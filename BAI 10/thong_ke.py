...
# ---------------------------------
# Copyright By Nguyen Quang Truong
# ---------------------------------
...
# frame chứa định dạng báo cáo
    def draw_ui(self):
        ...
        self.header_text = Label(self.content_frame,text='Báo cáo môn học Lập trình Python (FE6051)', anchor=CENTER, justify=CENTER, background='#fff')
        ...
        self.body_text5 = Label(self.content_frame, text='II. Kết quả xử lý số liệu',background='#fff', font=self.text_font, anchor=CENTER, justify=CENTER)
